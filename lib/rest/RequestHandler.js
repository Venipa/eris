...
class RequestHandler {
    constructor(client, options) {
        ...
        this._client = client;
        this.userAgent = client.options.userAgent || `DiscordBot (https://github.com/abalabahaha/eris, ${require("../../package.json").version})`;
        this.ratelimits = {};
        this.latencyRef = {
            latency: 500,
    ...
    request(method, url, auth, body, file, _route, short) {
        ...
        return new Promise((resolve, reject) => {
            ...
            const actualCall = (cb) => {
                ...
                }, this._client.bot ? {} : { "Referer": "https://discord.com/channels/@me" });
                let data;
                let finalURL = url;
